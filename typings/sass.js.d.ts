...
type SassOptions = 'defaults' | Sass.ISassOptions;
type SassResponseCallback = (result: Sass.SassResponse) => void;
...
export function importer(callback: ((request: Sass.SassImporterRequest, done: (result?: Sass.ISassImporterResponse) => void) => void) | null): void;